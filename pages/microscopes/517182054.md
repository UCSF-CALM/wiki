...
- [Kurt's Blog Triggering a device from multiple cameras]({{ "/assets/img/W1 set up-arduino.pdf" | relative_url }})
- [Kurt's Blog Interlocking mulitiple devices on a microscope]({{ "/assets/img/W1-interlocking-multiple devices.pdf" | relative_url }})
- [BNC Breakout Board Images]({{ "/assets/img/w1-board-wiringpicitre.pdf" | relative_url }})
- [BNC Breakout Board wiring diagram]({{ "/assets/img/W1 board wiring copy.pdf" | relative_url }})
...
### FRAP
<iframe src="pdf/microscope/W1/FRAP Set up W1-v2.pdf" width="100%" height="600px"></iframe>

...
- [Kurt's Blog Triggering a device from multiple cameras](/assets/img/W1 set up-arduino.pdf)
- [Kurt's Blog Interlocking mulitiple devices on a microscope](/assets/img/W1-interlocking-multiple devices.pdf)
- [BNC Breakout Board Images] (/ssets/img/w1-board-wiringpicitre.pdf)
- [BNC Breakout Board wireing diagram](/assets/img/W1 board wiring copy.pdf)

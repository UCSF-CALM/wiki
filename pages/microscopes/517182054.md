...
- [Kurt's Blog Triggering a device from multiple cameras]({{ "/assets/pdf/microscope/W1/W1 set up-arduino.pdf" | relative_url }})
- [Kurt's Blog Interlocking mulitiple devices on a microscope]({{ "/assets/pdf/microscope/W1/W1-interlocking-multiple devices.pdf" | relative_url }})
- [BNC Breakout Board Images]({{ "/assets/pdf/microscope/W1/w1-board-wiringpicitre.pdf" | relative_url }})
- [BNC Breakout Board wiring diagram]({{ "/assets/pdf/microscope/W1/W1 board wiring copy.pdf" | relative_url }})
...
### FRAP
<object data="../assets/pdf/microscope/W1/FRAP Set up W1-v2.pdf" width="1000" height="1000" type='application/pdf'></object>

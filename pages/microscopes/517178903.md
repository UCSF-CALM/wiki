...
## **[FPBASE](https://www.fpbase.org/microscope/JFEfwYnD6RpAZyTgh2PNkj/){.external-link rel="nofollow"}**
...
- Hammamatsu Orca Flash 4 (left port, COM 4). ~~Currently has Dual view
  splitter with DV2-Cube (T5101pxrt, ET460/36m, Et545/40m)~~

- Sutter LB 10-N filter Wheel in front of each camera

- Agilent MLC400 (405nm, 488nm, 561nm, 647nm) with NIDAQ interface
  (v18.oo)
...
- ~~R332 Serial connector- Intensilight ~~
...
- NIS-Elements 5.20.00 build 1423

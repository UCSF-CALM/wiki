...
- ~~Sutter Lambda LS-2 lamp for epifluorescence illumination~~

- Sola II LED (Lumencore)

- Sutter Emission wheel controlled by Lambda 10-B

- Sutter TLED brightfield illumination

- Photometrics Evolve Delta with 1.7X relay lens in front

- ~~Prior motorized stage with Piezo Z-drive~~
...
- 488 nm, 150 mW Coherent OBIS

- 561 nm, 100 mW Coherent OBIS
...
- 1 PCIe to highspeed serial port for Prior Proscan II (COM6)
...
- Ti-El: V5.2 Sum Fa24h

- TiPad: V5.1 Sum 08C4h
